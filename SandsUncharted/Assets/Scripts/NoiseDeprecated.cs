...
public static class Noise
{
    ...
    public static int PerlinNoise(int x, int y, int z, float frequency, float amplitude, float power)
    {
        float rValue;
        rValue = Noise.GetNoise(((double)x) / frequency, ((double)y) / frequency, ((double)z) / frequency);
        rValue *= amplitude;
