...
public static class Noise {
    ...
    /// <param name="lacunarity">Factor by what the frequency changes per octave (i.e. 2 to double). Range from 1 to 4.</param>
    /// <param name="persistence">Factor by what the amplitude changes (i.e. 0.5f to half it)</param>
    /// <returns></returns>
