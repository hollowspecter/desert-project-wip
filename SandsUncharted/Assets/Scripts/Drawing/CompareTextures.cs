...
public class CompareTextures : MonoBehaviour
{
    ...
    [SerializeField]
    private bool returnSolution = true;
    [SerializeField]
    ...
    public bool CompareTextureToPerfect(Texture2D texture, int resolution)
    {
        ...
        // only return the result if the flag is checked
        return returnSolution ? result : false;
    }
